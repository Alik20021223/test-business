...
export default function renderViewByLayout({
  ...
  switch (layout) {
    case 'onlyText':
      return (
        <TextOnlyBlock setOpen={setOpen} text={text} indicator={indicator} positive={positive} />
      );
    case 'imageText':
      return <ImageText setOpen={setOpen} text={text} indicator={indicator} positive={positive} />;
    case 'textImage':
      return <TextImage setOpen={setOpen} text={text} indicator={indicator} positive={positive} />;
    case 'imgLeftText':
      return (
        <TextWithImageBlock
          setOpen={setOpen}
