...
const OnlyTextEditor: React.FC<OnlyTextEditorProps> = ({
    ...
    return (
        ...
        >
            <div
                className={cn(
                    'border-gradient overflow-hidden rounded-[25px] bg-white flex justify-center items-center px-4',
                    className,
                )}
            >
                <textarea
                    ...
                    rows={1}
                    className={cn(
                        'flex justify-center min-h-[20px] w-full resize-none outline-none w-[313px]',
